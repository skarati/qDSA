...
void sign(u8* R, u8* s, u8* d1, u8* d2, u8* pk, u8 msg[32]){
	...
	for(i=0;i<62;i++) temp[i] = hashop[i];
	barrett_reduce(r16, temp);
	for(i=0;i<31;i++) r8[i] = (u8)r16[i];
